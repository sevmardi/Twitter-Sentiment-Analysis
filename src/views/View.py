...
import pd as pd
from src.services import Analyze as analyze
...
class View:
    def main(self):
        ...
        tweets['python'] = tweets['text'].apply(lambda tweet: analyze.word_in_text('python', tweet))
        tweets['javascript'] = tweets['text'].apply(lambda tweet: analyze.word_in_text('javascript', tweet))
        tweets['ruby'] = tweets['text'].apply(lambda tweet: analyze.word_in_text('ruby', tweet))
        ...
        tweets['programming'] = tweets['text'].apply(lambda tweet: analyze.word_in_text('programming', tweet))
        tweets['tutorial'] = tweets['text'].apply(lambda tweet: analyze.word_in_text('tutorial', tweet))
        tweets['relevant'] = tweets['text'].apply(
            lambda tweet: analyze.word_in_text('programming', tweet) or analyze.word_in_text('tutorial', tweet))
        ...
        # Extracting Links
        tweets['link'] = tweets['text'].apply(lambda tweet: analyze.extract_link(tweet))
